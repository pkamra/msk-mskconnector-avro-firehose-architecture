...
key.converter.endpoint=https://vpce-02ad457eddb4efb52-1tjj7rpe.glue.us-east-1.vpce.amazonaws.com
value.converter.endpoint=https://vpce-02ad457eddb4efb52-1tjj7rpe.glue.us-east-1.vpce.amazonaws.com
...
key.converter.schemaName=KAFKA-GLUEREGISTRY-SAMPLE-TOPIC
value.converter.schemaName=KAFKA-GLUEREGISTRY-SAMPLE-TOPIC
...
tasks.max=1
topics=KAFKA-GLUEREGISTRY-SAMPLE-TOPIC
batch=false
deliveryStream=PUT-MSK-CONNECT-GLUE
batchSizeInBytes=3670016
kinesisEndpoint=https://vpce-0cb8af5c994362624-2n1r2xnl.firehose.us-east-1.vpce.amazonaws.com
region=us-east-1
batchSize=1
...
logs - msk-connector-glue-firehose-json
arn:aws:logs:us-east-1:656151913794:log-group:msk-connector-glue-firehose-json:*
s3://msk-connect-glue-firehose-avro-modified/amazon-kinesis-kafka-connector-0.0.9-SNAPSHOT.jar
glue-firehose-avro-modified