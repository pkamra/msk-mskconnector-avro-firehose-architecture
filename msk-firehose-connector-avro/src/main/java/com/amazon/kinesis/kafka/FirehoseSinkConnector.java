...
public class FirehoseSinkConnector extends SinkConnector {
	...
	public void start(Map<String, String> props) {
		...
		/***Custom added by Piyali start ***/
		System.out.println("fireHose sink connector config -  :: ");
		System.out.println(props.get("key.converter.region"));
		System.out.println(props.get("key.converter.endpoint"));
		System.out.println(props.get("key.converter.registry.name"));
		System.out.println(props.get("key.converter.schemaName"));
		System.out.println(props.get("key.converter"));
		System.out.println(props.get("batchSize"));
		/***Custom added by Piyali end ***/
	}
	...
	public Class<? extends Task> taskClass() {
		System.out.printf("FirehoseSinkConnector#taskClass called");
