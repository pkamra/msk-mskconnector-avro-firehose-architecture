...
public class FirehoseSinkTask extends SinkTask {
	...
	public void put(Collection<SinkRecord> sinkRecords) {
		...
		if (batch) {
			System.out.println("FirehoseSinkTask put() method batch");
			putRecordsInBatch(sinkRecords);
		}
		else {
			System.out.println("FirehoseSinkTask put() method");
	...
	public void start(Map<String, String> props) {
		...
		if (!StringUtils.isNullOrEmpty(kinesisEndpoint)) {
			System.out.println("FireHose sinkTask Start");
			...
			System.out.println("FireHose sinkTask without region Start");
	...
	@Override
	public void stop() {
		System.out.printf("FirehoseSinkTask#stop() called");
	}
	...
	private void putRecordsInBatch(Collection<SinkRecord> sinkRecords) {
		...
		System.out.println("FirehoseSinkTask#putRecordsInBatch :: "+sinkRecords.size());
		for (SinkRecord sinkRecord : sinkRecords) {
			System.out.println("sinkRecord toString() "+sinkRecord.toString());
			System.out.println("sinkRecord valueSchema "+sinkRecord.valueSchema()+ " Value:: "+ sinkRecord.value() + " Type:: "+ sinkRecord.valueSchema().type());
	...
	private void putRecords(Collection<SinkRecord> sinkRecords) {
		System.out.println("FirehoseSinkTask#putRecords :: "+sinkRecords.size());
		for (SinkRecord sinkRecord : sinkRecords) {
			...
			try {
				System.out.println("SendData to firehose START  to :: "+ deliveryStreamName);
				firehoseClient.putRecord(putRecordRequest);
				System.out.println("SendData to firehose END to :: "+ deliveryStreamName);
			}catch(AmazonKinesisFirehoseException akfe){
				 System.out.println("Amazon Kinesis Firehose Exception:" + akfe.getLocalizedMessage());
			}catch(Exception e){
				 System.out.println("Connector Exception" + e.getLocalizedMessage());
